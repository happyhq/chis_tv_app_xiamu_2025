...
public class PaySuccessNewVersion extends BaseActivity {
    ...
    static final String TAG = "chis:PaySuccessActivity";
    ...
    protected  void onResume() {
        super.onResume();
        Log.d(TAG, "in Pay Success onResume");
        sendUIChangeMsg("PaySuccessPage.png");
    }
...
//
        ...
        backhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(PaySuccessNewVersion.this, MainActivity.class));
...
//        Log.e(TAG,"Passed stage 1 "+ request);
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    Log.e(String.valueOf(PaySuccessNewVersion.this), "onResponse: here");
