...
//    }
    ...
    class VoicePaySecurityCallBack extends PayCallBack
    {
        ...
        public void notifyPayCall(String code, String msg) {
            ...
            if (response.getres_code().equals("200")){
                Toast.makeText(VoiceCommandOrder.this,"pay success!", Toast.LENGTH_LONG).show();

                startActivity(new Intent(VoiceCommandOrder.this, PointPayActivity.class));

            }else{
                Toast.makeText(VoiceCommandOrder.this,"pay fail! ", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    protected  void onResume() {
        super.onResume();
        Log.d(TAG, "in VoiceCommandOrder activity onResume");
        sendUIChangeMsg("VoiceCommandOrder.png");
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.voice_command_order_page);
...
//        if(intent.getExtras() != null){
        prodname = intent.getStringExtra("voiceprod");
//        prodcount = intent.getStringExtra("prodcount");

        Log.e(TAG,"Product name: "+ prodname);

        //Log.e(TAG,"Product image: "+ imageuni);

        if(prodname.equals("灯")){
            prodname = "球泡灯\n5500积分";
            prodnamenew = "球泡灯";
            imageuni = String.valueOf(R.mipmap.bulblight_rec);
            textView.setText(prodname);
            imageView.setImageResource(R.mipmap.btn_as);

//            VoiceBuyDeviceInfo.voice_product_name = prodnamenew;
        } else if(prodname.equals("面板")){
            prodname = "智能面板\n5500积分";
            prodnamenew = "智能面板";
            imageuni = String.valueOf(R.mipmap.panel_rec);

            textView.setText(prodname);
            imageView.setImageResource(R.mipmap.btn_ds);
...
//        startActivity(new Intent(PayActivity2.this, PointPayActivity.class));
        ...
        backhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(VoiceCommandOrder.this, MainActivity.class));

            }
        });

        cxt=getApplicationContext();
        payTask=new PayTask(cxt,appid,packageName,new VoiceCommandOrder.VoicePaySecurityCallBack());
...
//        Log.e(TAG,"Passed stage 1 "+ request);
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    Log.e(String.valueOf(VoiceCommandOrder.this), "onResponse: here");
...
//        }
    ...
    public static Map<String,Object> get_pay_msg(){
        ...
        pay_msg.put("mPaynumber","82cd32f9386845e1");
        pay_msg.put("mAtt","CYN");
        pay_msg.put("mIcon",imageuni+"#"+prodnamenew);
        return pay_msg;
    }
    //    订单号生成
